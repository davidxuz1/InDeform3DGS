...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.use_inpainting = False  # Nuevo parámetro
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        #edit
        self.lambda_similarity = 0.5
        self.lambda_depth_inpaint = 0.5
        self.lambda_illumination = 0.5
        self.lambda_diversity = 0.5
        self.lambda_edge_smoothing = 0.5
        self.lambda_time_consistency = 0.5
        self.lambda_noise = 0.5
