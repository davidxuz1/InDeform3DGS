...
def main(
    data_path: Path = Path(os.path.join(PROJECT_ROOT, "data/intermediate/pose/pose_output")),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=Path,
        nargs="?",
        default=Path(os.path.join(PROJECT_ROOT, "data/intermediate/pose/pose_output")),
